        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Professional{' '}
              <span className="text-green-gradient">Vehicle Appraisals</span>
            </h1>
            
            <p className="text-xl text-gray-200 mb-8 leading-relaxed">
              Expert vehicle appraisal services for insurance, legal, and personal needs in East Brunswick.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: Search, title: "Professional Evaluation", description: "Expert assessment of vehicle condition and value" },
              { icon: Award, title: "Certified Appraisals", description: "Official documentation for insurance and legal needs" },
              { icon: TrendingUp, title: "Market Analysis", description: "Current market value and trend analysis" }
            ].map((service, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Get Professional{' '}
              <span className="text-green-gradient">Vehicle Appraisal</span>
            </h2>
